...
<div class="min-vh-100 d-flex flex-column">
    ...
    <main class="flex-grow-1 container py-5">
        <div class="mx-auto product-card-shadow" style="max-width: 900px; border: none; border-radius: 16px; padding: 2rem;">
            <h1 class="mb-4 fw-bold display-5">Add Product</h1>
            @if(session('success'))
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3 text-start">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="e.g., My Product" value="{{ old('name') }}"/>
                            {{-- @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror --}}
                        </div>

                        <div class="mb-3 text-start">
                            <label for="price" class="form-label fw-bold">Price ($)</label>
                            <input type="number" step="0.01" name="price" class="form-control @error('price') is-invalid @enderror" id="price" placeholder="e.g., 19.99" value="{{ old('price') }}"/>
                           
                        </div>

                        <div class="mb-3 text-start">
                            <label for="quantity" class="form-label fw-bold">Quantity</label>
                            <input type="number" name="quantity" class="form-control @error('quantity') is-invalid @enderror" id="quantity" placeholder="e.g., 100" value="{{ old('quantity') }}"/>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3 text-start">
                            ...
                            <textarea name="description" class="description form-control @error('description') is-invalid @enderror" id="description" placeholder="Enter Description for product..." rows="10">{{ old('description') }}</textarea>
